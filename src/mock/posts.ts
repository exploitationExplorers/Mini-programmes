...
export const posts: Post[] = [
  ...
  },
  {
    ...
    images: ['/static/post-image.png', '/static/post-image.png', '/static/post-image.png'],
    tags: ['手语学习', '日常交流'],
    likes: 78,
    comments: 23,
    shares: 15,
  ...
  },
  {
    ...
    images: ['/static/post-image.png', '/static/post-image.png'],
    tags: ['特殊教育', '辅助技术'],
    likes: 56,
    comments: 18,
    shares: 7,
